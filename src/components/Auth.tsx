          ...
          <div className="max-w-md">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 bg-white/10 rounded-xl backdrop-blur-sm">
                <div className="w-10 h-10 rounded-lg bg-[#FFEB7A]/20 flex items-center justify-center">
                  <svg className="w-5 h-5 text-[#FFEB7A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-sm font-semibold text-white">Real-time Analytics</h3>
                  <p className="text-xs text-white/60">Track performance across all investment types</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 bg-white/10 rounded-xl backdrop-blur-sm">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/60">Bank-level security for your investments</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 bg-white/10 rounded-xl backdrop-blur-sm">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/60">Comprehensive investment statements</p>
                </div>
              </div>
            </div>
          </div>
